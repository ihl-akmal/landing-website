  ...
  const cultures = [
    {
      ...
      description: 'Kami percaya setiap perempuan memiliki kekuatan luar biasa. Tugas kami adalah membantu mereka menemukan dan mengembangkan potensi tersebut 💪✨'
    },
    {
      icon: Users,
...
<section className="py-20 bg-gradient-to-br from-primary/5 via-pink-50 to-rose-50 relative overflow-hidden">
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
    ...
    {/* Founder Card */}
    <div className="bg-white rounded-3xl shadow-lg border border-pink-100 overflow-hidden relative">
      <div className="absolute top-0 right-0 w-40 h-40 bg-gradient-to-br from-primary/10 to-pink-100 rounded-full blur-3xl"></div>
      ...
      <div className="grid lg:grid-cols-2 gap-0 items-stretch">
        ...
        {/* Kolom Kiri - Foto Kapsul */}
        <div className="flex flex-col items-center justify-center p-12 relative overflow-hidden min-h-[500px]">
          <div className="absolute w-64 h-64 bg-gradient-to-br from-primary/20 to-pink-200/40 rounded-full blur-3xl -top-10 -left-10"></div>
          <div className="absolute w-40 h-40 bg-pink-300/20 rounded-full blur-2xl bottom-10 right-0"></div>

          <div className="relative z-10 group flex flex-col items-center">
            {/* Kapsul */}
            <div className="w-64 h-[420px] rounded-[100px] overflow-hidden border-4 border-white shadow-2xl relative">
              <div className="absolute inset-0 bg-gradient-to-t from-primary/70 via-primary/10 to-transparent z-10 group-hover:opacity-0 transition-opacity duration-300"></div>
              ...
              <div className="absolute bottom-0 left-0 right-0 p-8 z-20 text-center">
                <span className="text-white font-bold text-xl font-poppins">Ihlasul A'mal</span>
                <div className="flex items-center justify-center gap-2 mt-1">
                  
                  <span className="text-white/90 text-sm font-medium ">Founder & Program Lead</span>
                </div>
              </div>
            </div>

            {/* Ring luar */}
            <div className="absolute inset-0 rounded-[106px] border-2 border-primary/20 pointer-events-none"></div>

            {/* Floating heart */}
            <div className="absolute -top-2 -right-2 bg-primary rounded-full p-2 shadow-md z-20">
              <Heart className="h-3 w-3 text-white" />
            </div>

            {/* Social links */}
            <div className="flex gap-3 mt-6">
              <a href="https://instagram.com/ihl.akmal" target ="_blank" className="p-2 bg-gradient-to-br from-primary/10 to-pink-100 rounded-xl hover:bg-primary hover:text-white transition-colors duration-200 border border-primary/20">
              ...
              <a href="https://linkedin.com/in/ihlasulamal98" target="_blank" className="p-2 bg-gradient-to-br from-primary/10 to-pink-100 rounded-xl hover:bg-primary hover:text-white transition-colors duration-200 border border-primary/20">
                <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="flex flex-col justify-center p-12 relative z-10">
          <p className="text-gray-700 leading-relaxed text-lg mb-8">
           Ihlasul A'mal mendirikan Grazedu dari satu keresahan nyata di tengah derasnya arus media sosial, banyak perempuan muda yang tanpa sadar lebih fokus pada cara tampil daripada cara bertumbuh.
            <br /><br />
            Ia percaya perempuan Indonesia layak mendapat lebih dari itu. <span className="text-primary font-semibold">Berdaya, berkarakter, dan penuh nilai</span>, bukan sekadar eksis.
            <br /><br />
            Dengan pengalaman membimbing lebih dari 100 orang dalam memaksimalkan potensi dan skill mereka, serta rekam jejak sebagai mentor di program Kampus Merdeka, Ihlasul membangun Grazedu sebagai ruang nyata bagi perempuan untuk tumbuh dari dalam.
          </p>

          <div className="space-y-3">
            {[
              "Membimbing 100+ orang dalam pengembangan potensi & skill",
              "Mentor Program Kampus Merdeka",
              "Founder Platform Edukasi Perempuan",
            ].map((item, index) => (
