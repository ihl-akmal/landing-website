        ...
        <div className="flex flex-col items-center justify-center p-12 relative overflow-hidden min-h-[500px]">
          ...
          <div className="relative z-10 group flex flex-col items-center">
            ...
            <div className="flex gap-3 mt-6">
              <a href="#" className="p-2 bg-gradient-to-br from-primary/10 to-pink-100 rounded-xl hover:bg-primary hover:text-white transition-colors duration-200 border border-primary/20">
