import { getAllClasses, getClassesByCategory } from '@/app/data/classes';
                  ...
                  <div className="relative h-48 overflow-hidden">
                    ...
                    {classItem.level && (
                      <div className="absolute top-4 right-4">
                        <span className={`px-3 py-1 rounded-full text-xs font-semibold bg-white/90 text-gray-900 border border-white/60 shadow ${
                          classItem.level === 'Beginner' ? 'hidden' : ''
                        }`}>
                          {/* Placeholder: replaced in slug page */}
                        </span>
                      </div>
                    )}
                  </div>
