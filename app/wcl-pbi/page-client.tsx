    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-16 bg-gray-50">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl font-bold text-gray-800 text-center">Pendekatan <span className="text-primary"> Women-Centric & Real Project</span></h2> 
            ...
            <CardFooter>
                ...
                <Card className="bg-white border-2 border-primary shadow-lg text-left hover:scale-105 transition-transform flex flex-col">
                    <CardHeader>
                        ...
                        <CardDescription className="text-base text-gray-600">1 bulan · Full Online</CardDescription>
                    </CardHeader>
                    <CardContent className="mt-auto">
                      
                    <span className="text-sm text-gray-400 line-through">Rp 699.000</span>
                    <span className="text-lg font-bold text-primary"> Rp 399.000</span>
                    </CardContent>
                    <CardFooter className="mt-auto">
