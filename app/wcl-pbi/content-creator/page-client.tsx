          ...
          >
            ...
            <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
              ...
              <div className="flex items-center gap-2 text-sm text-white mb-8 font-medium">
                ...
                <span>•</span>
                <span className="text-white font-extrabold">Content Creator</span>
              </div>
          ...
          <section className="py-16 bg-gray-50">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="space-y-4 text-gray-700 leading-relaxed">
                <p>
                  Women's Career Lab (WCL) - Project Based Internship Content Creator adalah program yang dirancang untuk memberdayakan perempuan muda yang ingin
